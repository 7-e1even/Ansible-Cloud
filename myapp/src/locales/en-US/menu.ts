export default {
  ...
  'menu.ansible': 'Ansible UI',
  'menu.ansible.hosts': 'Host Management',
  'menu.ansible.terminal': 'Web Terminal',
  'menu.ansible.templates': 'Template Management',
  'menu.ansible.batch_execute': 'Batch Execute',
